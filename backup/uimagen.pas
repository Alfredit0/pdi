...
begin
  ...
  begin
    nom := OpenDialog1.FileName;
    Picture.LoadFromFile(nom);
    BM2.Width:=Picture.Width;
    BM2.Height:=Picture.Height;
    BM2.Canvas.Draw(0,0, Picture.Graphic);
...
begin
   ...
   Image1.Stretch:= True;
   Image1.Height:= ScrollBox1.Height-5;
   Image1.Width:=ScrollBox1.Width-5;
   MImagen(BM);
end;
